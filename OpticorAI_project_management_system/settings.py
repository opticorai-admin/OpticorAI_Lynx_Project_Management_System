...
# ALLOWED HOSTS / CSRF
ALLOWED_HOSTS = os.environ.get('DJANGO_ALLOWED_HOSTS', 'web-production-60bd4.up.railway.app, 127.0.0.1,localhost').split(',')
CSRF_TRUSTED_ORIGINS = os.environ.get('DJANGO_CSRF_TRUSTED_ORIGINS', 'web-production-60bd4.up.railway.app').split(',') if not DEBUG else []
